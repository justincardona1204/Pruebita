...
public class ReservationController {
    ...
    @PutMapping("/update")
    @ResponseStatus(HttpStatus.CREATED)
    public Reservation updateReservation(@RequestBody Reservation reservacionesd) {
        return objReservationService.updateReservation(reservacionesd);
    }

    @DeleteMapping("{id}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public Boolean delReservation(@PathVariable Integer id) {
        return objReservationService.delReservation(id);
    }
